---
# Managed by @plainconceptsplatform/workflows@0.27.5. Source: loops/workflows/agent-visual-verify.md. Update with `workflows update --force`; consumer edits may be overwritten.
env:
