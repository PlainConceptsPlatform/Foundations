// Managed by @plainconceptsplatform/workflows@0.27.5. Source: loops/actions/agent-output.cjs. Update with `workflows update --force`; consumer edits may be overwritten.
