#!/usr/bin/env bash
# Managed by @plainconceptsplatform/workflows@0.27.5. Source: loops/actions/assess-blast-radius/assess-blast-radius.sh. Update with `workflows update --force`; consumer edits may be overwritten.
