#!/usr/bin/env bash
# Managed by @plainconceptsplatform/workflows@0.27.5. Source: loops/actions/apply-agent-bundle/apply-bundle.sh. Update with `workflows update --force`; consumer edits may be overwritten.
set -euo pipefail
