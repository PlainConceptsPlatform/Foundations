#!/usr/bin/env bash
# Managed by @plainconceptsplatform/workflows@0.27.5. Source: loops/actions/verify-route-matrix/verify-route-matrix.sh. Update with `workflows update --force`; consumer edits may be overwritten.
