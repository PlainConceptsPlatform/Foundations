#!/usr/bin/env bash
# Managed by @plainconceptsplatform/workflows@0.27.5. Source: loops/actions/collect-app-errors/query-app-errors.sh. Update with `workflows update --force`; consumer edits may be overwritten.
#
