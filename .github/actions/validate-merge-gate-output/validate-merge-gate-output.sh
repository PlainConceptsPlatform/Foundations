#!/usr/bin/env bash
# Managed by @plainconceptsplatform/workflows@0.27.5. Source: loops/actions/validate-merge-gate-output/validate-merge-gate-output.sh. Update with `workflows update --force`; consumer edits may be overwritten.
