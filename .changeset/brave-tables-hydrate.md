---
"@plainconceptsplatform/ui-components": minor
"@plainconceptsplatform/ui-theme": minor
---

Fix a hydration mismatch in `DataTable`, add the missing sidebar and chart token groups, and make "no
