...
`plain-engineering-conventions`, `plain-dotnet-guardrails`, `clean-ddd-hexagonal`, `dotnet-backend-patterns`, `modern-csharp-coding-standards`, `optimizing-ef-core-queries`, `csharp-xunit`. See [AI and agents](/docs/ai) for how to install them.
