---
title: How to
description: "How Platform runs AI agents: GitHub Agentic Workflows on ubuntu-latest against the Forge gateway is the recommendation, with opencode-onboard, loop-task, and orbion around it."
---
