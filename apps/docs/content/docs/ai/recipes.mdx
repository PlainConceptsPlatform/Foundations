...
These are the recipes running in production on Platform projects. They are the best reference for building real loop-engineering pipelines: multi-task chains with recovery, retry caps, AI agents, and GitHub label state machines.
