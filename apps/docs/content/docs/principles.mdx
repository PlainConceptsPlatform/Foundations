...
A convention costs a paragraph. Shared code costs a version, a migration path, and a maintainer. Reach for the paragraph first. [Contributing](/docs/contributing) covers the process.
